...
const ModalSubirFotos = ({ open, onClose, fotos, onFotosChange, subtipoSeleccionado }) => {
    ...
    const FORMATOS_VIDEO_PERMITIDOS = ['video/mp4', 'video/avi', 'video/wmv'];
        ...
        >
            ...
            <DialogContent sx={{ pt: 1 }}>
                ...
                <Alert severity="info" sx={{ mb: 2, fontSize: '0.875rem' }}>
                    • Máximo {MAX_FOTOS} archivos
                    • Fotos: Máximo 10 MB por archivo
                    • Formatos de imagen: JPG, PNG, GIF, WEBP
                    {permiteVideo && (
                        <>
                            <br />
                            • Videos: Máximo {MAX_VIDEO_SIZE_MB}MB y 15 segundos
                            • Formatos de video: MP4, AVI, WMV
                        </>
                    )}
                </Alert>
